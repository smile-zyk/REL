...
void register_xdataset_bindings(pybind11::module_& m)
{
    ...
    pybind11::class_<DataArray>(m, "DataArray", pybind11::buffer_protocol())
        ...
        .def_property_readonly("hint", &DataArray::hint)
        .def("set_hint", &DataArray::set_hint)
    ...
    pybind11::class_<Block>(m, "Block")
        ...
        .def_property_readonly("dataset_name", &Block::dataset_name)
        .def_property_readonly("source_path", &Block::source_path)
    ...
    pybind11::class_<Dataset>(m, "Dataset")
        ...
        .def_property_readonly("source_path", &Dataset::source_path)
